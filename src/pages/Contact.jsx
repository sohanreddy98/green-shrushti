...
const channels = [
  {
    label: 'Call us',
    value: '+91 8482 841702',
    note: 'Mon–Sat, 9:30 AM – 6:30 PM IST',
    href: 'tel:+918482841702',
    icon: (
  ...
  {
    label: 'Email',
    value: 'support@greenshrushti.in',
    note: 'For commercial & project enquiries',
    href: 'mailto:support@greenshrushti.in',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
          ...
          <div className="contact-form-wrap">
            {sent ? (
              <div className="contact-sent">
                ...
                <p className="contact-sent-sub">For urgent matters, WhatsApp us at <a href="https://wa.me/918482841702">+91 8482 841702</a>.</p>
              </div>
            ) : (
